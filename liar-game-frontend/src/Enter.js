...
//       document.getElementById("usernameValidationLabel").innerHTML =
//         "please enter between 1 and 40 characters";
//     }
...
//         username:
//       </label>{" "}
//       {/*check for uniqueness, or just add a number to the end if not unique*/}
...
//         enter
//       </button>
//       <p className="usernameValidationLabel" id="usernameValidationLabel">
//         (alphanumeric only)
//       </p>
//     </div>
//   );
